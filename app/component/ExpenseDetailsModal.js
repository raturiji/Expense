...
export default  ExpenseDetailsModal = () => {
    return (
        <ScrollView style={[inlineStyles.detailsModal,styles.phSm,styles.pvSm,styles.mh]}>
            ...
            <View style={[inlineStyles.listItem,styles.row,styles.between,{paddingBottom:hp(5)}]}>
                <View>
                    <Text style={[inlineStyles.customHeading]}>
                        Total
                    </Text>
